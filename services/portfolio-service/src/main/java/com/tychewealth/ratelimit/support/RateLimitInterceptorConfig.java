...
public class RateLimitInterceptorConfig {
  ...
  private final RateLimitCallbacksDto callbacks;
  ...
  public RateLimitInterceptorConfig(
      ...
      RateLimitCallbacksDto callbacks,
    ...
    this.callbacks = Objects.requireNonNullElseGet(callbacks, RateLimitCallbacksDto::none);
