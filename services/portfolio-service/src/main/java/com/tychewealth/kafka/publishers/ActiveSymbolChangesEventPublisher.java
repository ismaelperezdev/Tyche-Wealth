...
/**
 * Publishes active-symbol changes to the configured Kafka topic.
 *
 * <p>Waits for the send result up to the configured delivery timeout and converts interruptions,
 * timeouts, and send failures into an {@link EventPublishingException}.
 */
@Component
@Slf4j
