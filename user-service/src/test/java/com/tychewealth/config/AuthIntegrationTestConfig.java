...
public class AuthIntegrationTestConfig {
  ...
  public static class Initializer
    ...
    /**
     * Initializes the application context for integration tests by applying test-specific environment properties.
     *
     * <p>Sets the Liquibase changelog location, a test JWT secret, and rate-limit settings for registration,
     * login, and token refresh operations.</p>
     *
     * @param applicationContext the configurable application context to initialize
     */
    @Override
