...
class PortfolioMapperTest {
  ...
  void setUp() {
    ...
    responseFixture =
        FixtureLoader.read(
            "/fixtures/portfolio/portfolio-response.json", PortfolioResponseDto.class);
    createFixture =
        FixtureLoader.read(
            "/fixtures/portfolio/portfolio-create-request.json", PortfolioCreateRequestDto.class);
    updateFixture =
        FixtureLoader.read(
            "/fixtures/portfolio/portfolio-update-request.json", PortfolioUpdateRequestDto.class);
  }
