...
class AssetMapperTest {
  ...
  void setUp() {
    ...
    responseFixture =
        FixtureLoader.read("/fixtures/asset/asset-response.json", AssetResponseDto.class);
    createFixture =
        FixtureLoader.read(
            "/fixtures/asset/asset-create-request.json", AssetCreateRequestDto.class);
    updateFixture =
        FixtureLoader.read(
            "/fixtures/asset/asset-update-request.json", AssetUpdateRequestDto.class);
  }
